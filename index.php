            ...
            <section class="section section--tight" id="specialization">
                <div class="container">
                    ...
                    <div class="spec-grid" aria-label="Карточки направлений работы">
                        <a class="spec-card spec-card--heart" href="rezultaty-rabot.php#direction-coronary-stenting">
                        ...
                        <a class="spec-card" href="rezultaty-rabot.php#direction-carotid-stenting">
                            <div class="spec-card__icon" aria-hidden="true">
                        ...
                        <a class="spec-card" href="rezultaty-rabot.php#direction-lower-limb-arteries">
                            <div class="spec-card__icon" aria-hidden="true">
                        ...
                        <a class="spec-card" href="rezultaty-rabot.php#direction-venous-stenting">
                            <div class="spec-card__icon" aria-hidden="true">
                        ...
                        <a class="spec-card" href="rezultaty-rabot.php#direction-uterine-artery-embolization">
                            <div class="spec-card__icon" aria-hidden="true">
                        ...
                        <a class="spec-card" href="rezultaty-rabot.php#direction-varicocele-embolization">
                            <div class="spec-card__icon" aria-hidden="true">
