...
$meta = [
    'title' => 'Дипломы — кардиохирург',
    'description' => 'Документы, подтверждающие квалификацию и профильное образование. Запись через форму на сайте.'
];
$pageTitle = 'Дипломы';
$pageSubtitle = 'Документы, подтверждающие квалификацию и профильное образование.';
...
?>
    ...
    <section class="inner-section"><div class="container"><h2 class="section__title section__title--left">Галерея документов</h2>
      <div class="doc-grid">
        <article class="doc-card"><button type="button" data-diploma-open data-image="assets/img/content/result-01.svg" data-alt="Диплом 1">Диплом 1<br><!-- TODO: Вставить реальные дипломы и сертификаты --></button></article>
        <article class="doc-card"><button type="button" data-diploma-open data-image="assets/img/content/result-02.svg" data-alt="Сертификат 2">Сертификат 2</button></article>
      </div></div></section>
      <div class="modal" data-diploma-modal hidden><button class="modal__close" type="button" data-diploma-close>×</button><img class="modal__content" src="" alt=""></div>
