...
$meta = [
    'title' => 'О враче — кардиохирург',
    'description' => 'Профессиональный путь, опыт и подход к лечению сердечно-сосудистых заболеваний. Запись через форму на сайте.'
];
$pageTitle = 'О враче';
$pageSubtitle = 'Профессиональный путь, опыт и подход к лечению сердечно-сосудистых заболеваний.';
