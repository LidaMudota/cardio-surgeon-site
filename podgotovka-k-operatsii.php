...
$meta = [
    'title' => 'Подготовка к операции — кардиохирург',
    'description' => 'Чек-лист подготовки перед плановым оперативным лечением. Запись через форму на сайте.'
];
$pageTitle = 'Подготовка к операции';
$pageSubtitle = 'Чек-лист подготовки перед плановым оперативным лечением.';
