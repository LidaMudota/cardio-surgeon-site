...
$meta = [
    'title' => 'Специализация — кардиохирург',
    'description' => 'Ключевые направления кардиохирургической помощи и экспертные компетенции. Запись через форму на сайте.'
];
$pageTitle = 'Специализация';
$pageSubtitle = 'Ключевые направления кардиохирургической помощи и экспертные компетенции.';
