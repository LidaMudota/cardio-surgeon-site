...
$meta = [
    'title' => 'Результаты работ — эндоваскулярный хирург',
    'description' => 'Клинические случаи с описанием задачи, выбранной тактики и результата. Запись через форму на сайте.'
];
$pageTitle = 'Результаты работ';
$pageSubtitle = 'Клинические случаи с описанием задачи, выбранной тактики и результата.';
