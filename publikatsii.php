...
$meta = [
    'title' => 'Публикации — кардиохирург',
    'description' => 'Экспертные материалы, заметки и профессиональные публикации врача. Запись через форму на сайте.'
];
$pageTitle = 'Публикации';
$pageSubtitle = 'Экспертные материалы, заметки и профессиональные публикации врача.';
