<header class="header" id="top">
    <div class="container header__inner">
        ...
        <div class="header__actions">
            <button class="header__menu-button" type="button" data-menu-toggle aria-expanded="false" aria-controls="mega-menu">МЕНЮ</button>

            <div class="header__socials">
                <a class="header__icon-link" href="https://t.me/your_username" target="_blank" rel="noopener noreferrer" aria-label="Telegram" title="Telegram">
                    <img src="assets/img/icons/max.svg" alt="max" class="header__icon-image">
                </a>
                <a class="header__icon-link" href="https://wa.me/79990000000" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" title="WhatsApp">
                    <img src="assets/img/icons/telegram.svg" alt="telegram" class="header__icon-image">
                </a>
            </div>

            <a class="button button--accent button--small" href="konsultatsiya.php#consultation-form">Записаться</a>
    ...
    <div class="mega-menu" id="mega-menu" hidden>
        <div class="container mega-menu__inner">
            ...
            <div class="mega-menu__preview">
                ...
                <a class="button button--accent button--small" href="konsultatsiya.php#consultation-form">Записаться на консультацию</a>
            </div>
        </div>
    </div>
