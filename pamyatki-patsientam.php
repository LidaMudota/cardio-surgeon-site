...
$meta = [
    'title' => 'Памятки пациентам — эндоваскулярный хирург',
    'description' => 'Практические инструкции перед консультацией, госпитализацией и после выписки. Запись через форму на сайте.'
];
$pageTitle = 'Памятки пациентам';
$pageSubtitle = 'Практические инструкции перед консультацией, госпитализацией и после выписки.';
