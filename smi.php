...
$mediaItems = [
    [
        'type' => 'Видео / подкаст',
        'title' => 'ЭКГ в норме, а сосуды ЗАБИТЫ? Как не пропустить бляшки в сердце.',
        'description' => 'Продолжаем серию видео с кардиологом Тамазом Гаглошвили — автором «Блога Кардиолога».

Как найти бляшки в сердце? Разбираем, с каких неинвазивных тестов — нагрузочных проб и стресс-Эхо — стоит начинать обследование, чем МСКТ-коронарография отличается от классической ангиографии, что показывает индекс коронарного кальция и когда достаточно лекарственной терапии, а когда требуется стентирование или шунтирование. Также обсуждаем реальные риски и противопоказания к коронарографии.',
        'source' => 'youtube.com / vkvideo.ru',
        'links' => [
            [
                'label' => 'Открыть на YouTube',
                'url' => 'https://youtu.be/OQ6tfNjmuNk',
            ],
            [
                'label' => 'Открыть в VK',
                'url' => 'https://vk.ru/wall-210934520_172998',
            ],
        ],
    ],
    [
