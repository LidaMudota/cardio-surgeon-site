...
$mediaItems = [
    [
        'type' => 'Видео / подкаст',
        'title' => 'Жизнь после СТЕНТА! Что можно и что НЕЛЬЗЯ? Пошаговая инструкция',
        'description' => 'Продолжаем серию видео с кардиологом Тамазом Гаглошвили (Блог Кардиолога):

Если вам или вашим близким выполняли эту операцию, или вы просто хотите знать, как работает современная кардиохирургия и реабилитация — этот выпуск обязателен к просмотру.

Стент поставили, но риск остался? Почему после идеальной операции люди всё равно умудряются получить повторный инфаркт?

Что на самом деле лечит стент, а в чем он абсолютно бессилен?

Пошаговый гид по ограничениям: спорт, баня, секс, алкоголь и перелеты — где реальные табу, а где надуманные мифы?

Тромбоз и рестеноз: как понять, что вы в зоне риска, и предотвратить катастрофу?

Препараты после операции: почему статины и дезагреганты — это не «лишняя химия», а ваша единственная страховка?',
        'source' => 'youtube.com / vkvideo.ru',
        'links' => [
            [
                'label' => 'Открыть на YouTube',
                'url' => 'https://youtu.be/2dkjN9Ji-Jo?is=zRVdh037nXpzhh7Z',
            ],
            [
                'label' => 'Открыть в VK',
                'url' => 'https://vkvideo.ru/video-210934520_456241074?list=938df87469e85bb205',
            ],
        ],
    ],
    [
