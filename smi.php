...
$mediaItems = [
    [
        'type' => 'Видео / YouTube',
        'title' => 'Главная ОШИБКА после стентирования. Почему стент забивается ТРОМБОМ?',
        'description' => 'Что категорически нельзя делать после установки стента? Как не допустить тромбоза и избежать повторного инфаркта? Разбираем главные ошибки пациентов после выписки.',
        'source' => 'youtube.com',
