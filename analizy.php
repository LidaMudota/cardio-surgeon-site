...
$meta = [
    'title' => 'Анализы — кардиохирург',
    'description' => 'Перечень обследований и анализов для консультации и подготовки к операции. Запись через форму на сайте.'
];
$pageTitle = 'Анализы';
$pageSubtitle = 'Перечень обследований и анализов для консультации и подготовки к операции.';
