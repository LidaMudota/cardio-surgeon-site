...
$meta = [
    'title' => 'Консультация — кардиохирург',
    'description' => 'Что включает консультация кардиохирурга и как к ней подготовиться. Запись через форму на сайте.'
];
$pageTitle = 'Консультация';
$pageSubtitle = 'Что включает консультация кардиохирурга и как к ней подготовиться.';
