...
$meta = [
    'title' => 'Консультация — эндоваскулярный хирург',
    'description' => 'Что включает консультация эндоваскулярного хирурга и как к ней подготовиться. Запись через форму на сайте.'
];
