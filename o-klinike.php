...
$meta = [
    'title' => 'О клинике — кардиохирург',
    'description' => 'Информация о месте приёма, условиях и оснащении для комфортного лечения. Запись через форму на сайте.'
];
$pageTitle = 'О клинике';
$pageSubtitle = 'Информация о месте приёма, условиях и оснащении для комфортного лечения.';
