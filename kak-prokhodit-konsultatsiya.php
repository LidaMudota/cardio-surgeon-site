...
$meta = [
    'title' => 'Как проходит консультация — кардиохирург',
    'description' => 'Детальный сценарий первичного и повторного приема. Запись через форму на сайте.'
];
$pageTitle = 'Как проходит консультация';
$pageSubtitle = 'Детальный сценарий первичного и повторного приема.';
