...
$meta = [
    'title' => 'После операции — эндоваскулярный хирург',
    'description' => 'Рекомендации по восстановлению и контрольным визитам. Запись через форму на сайте.'
];
$pageTitle = 'После операции';
$pageSubtitle = 'Рекомендации по восстановлению и контрольным визитам.';
