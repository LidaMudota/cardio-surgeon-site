...
$meta = [
    ...
    'description' => 'Мнения пациентов о консультациях, лечении и сопровождении. Запись через форму на сайте.'
];
$pageTitle = 'Отзывы';
$pageSubtitle = 'Мнения пациентов о консультациях, лечении и сопровождении.';
