...
$meta = [
    'title' => 'Как проходит операция — эндоваскулярный хирург',
    'description' => 'Пошаговый маршрут пациента от подготовки до раннего восстановления. Запись через форму на сайте.'
];
$pageTitle = 'Как проходит операция';
$pageSubtitle = 'Пошаговый маршрут пациента от подготовки до раннего восстановления.';
